...
| target | Ligand + Boltz-2 | 0.769 | 0.618 | 0.315 | 0.413 |
...
Artifact checks and local downstream reproduction passed. The run emitted RDKit serialization-version warnings whose effect has not been resolved by a matched-version rerun. Treat these results as a provisional pilot. See [audit.json](audit.json) and [validation details](../../docs/GPU_VALIDATION.md).
